 ...
 */
  static verifyPassword(userPasswordFromDB: string, providedPassword: string): boolean {
    return bcrypt.compareSync(providedPassword + this.pepper, userPasswordFromDB);
  }
